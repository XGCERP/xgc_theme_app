        ...
        function(results) {
          ...
          if (results.length) {
            for (const v of results) {
              var row = $(
                repl(
                  '<div class="row link-select-row">						<div class="col-xs-4 ellipsis">							<b><a href="#">%(name)s</a></b></div>						<div class="col-xs-8 ellipsis">							<span class="text-muted">%(values)s</span></div>						</div>',
                  {
                    name: v[0],
...
//# sourceMappingURL=dialog.bundle.MDNKDWFM.js.map
